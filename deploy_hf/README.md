...
# AI Support Triage Operations Environment

A structured, policy-driven evaluation environment for Customer Support AI agents. Developed for the **Meta x PyTorch OpenEnv Hackathon**.

##      Author
**Ayush Anand** (@truthcodeexplorer)

##      Project Overview
This environment evaluates an AI agent's ability to:
1. **Triage**: Categorize and prioritize incoming tickets.
2. **Resolve**: Draft accurate, professional responses based on internal policy.
3. **Escalate**: Route complex cases to the correct specialized department.
...
---
*Built with        for the SST OpenEnv Hackathon.*
